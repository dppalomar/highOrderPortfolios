...
?design_MVSK_portfolio_via_sample_moments  # to get help for the function
```

The simplest use is for the [mean-variance-skewness-kurtosis (MVSK) portfolio](#mvsk-portfolio):
...
# estimate moments of multiple assets
