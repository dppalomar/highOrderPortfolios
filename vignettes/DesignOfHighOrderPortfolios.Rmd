...
The package **highOrderPortfolios** implements the algorithms designed in the paper [@ZhouPalomar2021]. The two main problem formulations covered in that paper are mean-variance-skewness-kurtosis (MVSK) and mean-variance-skewness-kurtosis tilting (MVSKT) problems.
